...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'nolelium', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || true, // 是否显示切换主题按钮
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  SINCE: process.env.NEXT_PUBLIC_SINCE || 1994, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '任正非', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '华为任正非语录', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://huawei.meme', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，huawei，华为，任正非，Renzhengfei', // 网站关键词 英文逗号隔开
